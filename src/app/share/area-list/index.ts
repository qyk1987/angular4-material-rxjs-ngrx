    ...
    <div class="address-group">
      ...
      <div class="street">
        <md-input-container class="full-width">
          <input mdInput placeholder="工作单位" [(ngModel)]="_address.street" (change)="onStreetChange()">
        </md-input-container>
      </div>
    </div>
    `,
...
export class AreaListComponent implements ControlValueAccessor, OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.cities$ = province$.mergeMap(province => {
        console.log("获取城市"+province);
      return Observable.of(getCitiesByProvince(province))});
    // 根据省份和城市的选择得到地区列表
